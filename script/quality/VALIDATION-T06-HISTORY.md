...
此文件保留最终稳定候选验收前的原始记录，包含当时的失败、待验、Latest 和未提交状态。
这些措辞不代表当前状态；最终产物与验证范围请见 [T06 验证报告](VALIDATION-T06.md)。
早期 T06 开发 build1–11 与本轮 stable-build1–6 是不同序列，不应混用编号。

原正文 SHA-256：`af43547a93fe18287c0ba3a1e1e0c2fefacd0a09cde61017d758969d1d38829e`。下方原正文按字节保留。

<!-- BEGIN PRESERVED ORIGINAL BODY -->
